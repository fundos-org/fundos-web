      ...
      <div className="space-y-6">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-gray-50 border border-gray-200 text-gray-900 px-4 py-3 rounded-lg flex items-center justify-between">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-gray-50 border border-gray-200 text-gray-900 px-4 py-3 rounded-lg max-w-md">
