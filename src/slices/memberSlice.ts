...
import { MemberApiResponse, Members, Statistics } from "@/constants/membersConstant";
...
const memberSlice = createSlice({
    ...
    extraReducers(builder) {
        builder
            ...
            .addCase(fetchMembersStatistics.fulfilled, (state, {payload}: PayloadAction<MemberApiResponse>) => {
                state.loading = false;
            ...
            .addCase(fetchMembersStatistics.rejected, (state, action: PayloadAction<CommonError | undefined>) => {
                state.loading = false;
